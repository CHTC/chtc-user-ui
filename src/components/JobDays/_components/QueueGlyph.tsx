 ...
 *
 * Heads the queue scale down the right of the calendar, and the matching scale
 * in the cell guide's example, so the reader can see which axis the grey level
 * trace answers to.
 */
