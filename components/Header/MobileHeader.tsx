    ...
    <Toolbar disableGutters>
      <Grid container justifyContent="space-between" alignItems="center" flexGrow={1}>
        ...
        <Grid size={"auto"} display={{ xs: "none", sm: "block" }}>
          <Box display={"flex"} justifyContent={"right"} alignItems={"center"} gap={2}></Box>
        </Grid>
      </Grid>
      <Drawer anchor="left" open={navOpen} onClose={handleDrawerClose}>
        <Box sx={{ width: "100vw" }} role="presentation" onClick={handleDrawerClose} onKeyDown={handleDrawerClose}>
          <List sx={{ pt: 0 }}>
